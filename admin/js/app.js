...
const db = {
  ...
  events: [{ id: "seed-1", title: "বার্ষিক শীতকালীন ক্যাম্প" }, { id: "seed-2", title: "পাহাড়ি হাইকিং অভিযান" }],
  gallery: [{ id: "seed-1", src: "camp1" }, { id: "seed-2", src: "hike2" }, { id: "seed-3", src: "group3" }],
